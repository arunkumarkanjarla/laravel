...
<meta charset="utf-8">
<link rel="stylesheet" href="{{url('css/reset.css')}}" type="text/css" media="all">
<link rel="stylesheet" href="{{url('css/layout.css')}}" type="text/css" media="all">
<link rel="stylesheet" href="{{url('css/style.css')}}" type="text/css" media="all">
<script type="text/javascript" src="{{url('js/jquery-1.5.2.js')}}" ></script>
<script type="text/javascript" src="{{url('js/cufon-yui.js')}}"></script>
<script type="text/javascript" src="{{url('cufon-replace.js')}}js/"></script>
<script type="text/javascript" src="{{url('js/Molengo_400.font.js')}}"></script>
<script type="text/javascript" src="{{url('js/Expletus_Sans_400.font.js')}}"></script>
<!--[if lt IE 9]>
  ...
  <div class="main">
    ...
    <header>
      <div class="wrapper">
        ...
        <ul id="icon">
          <li><a href="#"><img src="{{ URL('storage/icon1.jpg') }}" alt=""></a></li>
          <li><a href="#"><img src="{{ URL('storage/icon2.jpg') }}" alt=""></a></li>
          <li><a href="#"><img src="{{ URL('storage/icon3.jpg') }}" alt=""></a></li>
        </ul>
      </div>
      <div class="wrapper">
      ...
      <ul class="banners">
        <li><a href="#"><img src="{{ URL('storage/banner1.jpg') }}" alt=""></a></li>
        <li><a href="#"><img src="{{ URL('storage/banner2.jpg') }}" alt=""></a></li>
        <li><a href="#"><img src="{{ URL('storage/banner3.jpg') }}" alt=""></a></li>
      </ul>
      ...
      <div class="wrapper">
        <div class="pad1 pad_top1">
          <article class="cols marg_right1">
            <figure><a href="#"><img src="{{ URL('storage/page1_img1.jpg') }}" alt=""></a></figure>
            <span class="font1">Our Mission Statement</span> </article>
          <article class="cols marg_right1">
            <figure><a href="#"><img src="{{ URL('storage/page1_img2.jpg') }}" alt=""></a></figure>
            <span class="font1">Performance Report</span> </article>
          <article class="cols">
            <figure><a href="#"><img src="{{ URL('storage/page1_img3.jpg') }}" alt=""></a></figure>
      ...
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            ...
            <div class="wrapper">
              <figure class="left marg_right1"><img src="{{ URL('storage/page1_img4.jpg') }}" alt=""></figure>
